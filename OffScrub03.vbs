...
Dim sAllusersProfile, sOSinfo, sOSVersion, sLogPrefix, sCommonProgramFilesX86, sProfilesDirectory
...
Sub TmpKeyCleanUp
    ...
    If fLogInitialized Then Log "Clear temporary OffScrub registry entries"
...
Sub LogSkuResults
    ...
    Set SkuLog = oFso.OpenTextFile(sLogPrefix & "_SkuLog.txt",FOR_WRITING,True,True)
